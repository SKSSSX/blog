...
- 凡是通过git clone从github上拉取的代码，删除<span style="color: #fe2c23">除了项目根目录以外的</span>任何位置的<strong> .git文件夹，.gitignore (或者编辑这个文件夹，删除那些你想上传但是被忽略的文件或文件夹) 和 .github 文件夹</strong>
